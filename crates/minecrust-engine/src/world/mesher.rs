...
impl Mesher {
    ...
    pub fn mesh_chunk<F, O>(chunk: &Chunk, data_resolver: F, is_opaque: O) -> ChunkMesh
    where
        F: Fn(u16, usize) -> ([f32; 4], [f32; 4]),
        O: Fn(u16) -> bool,
    {
    ...
    fn add_face(vertices: &mut Vec<Vertex>, indices: &mut Vec<u32>, pos: Vec3, normal: Vec3, uvs: [f32; 4], color: [f32; 4]) {
